...
public class Controlador {
    ...
    public static boolean validarFecha(final String fechaAlta){
        if(fechaAlta != null){
            String anio = "^\\d+";
            String mesesBisiestos = "((01/([012][\\d]|3[01])|" +
                    ...
                    "(11/([012][\\d]|3[0]))|" +
                    "(12/([012][\\d]|3[01]))))";
            String mesesNoBisiestos = "((01/([012][\\d]|3[01])|" +
                    "(02/([01][\\d]|2[012345678]))|" +
                    "(03/([012][\\d]|3[01]))|" +
                    "(04/([012][\\d]|3[0]))|" +
                    "(05/([012][\\d]|3[01]))|" +
            ...
            String fecha = (bisiesto == 0) ? anio + "/" +  mesesBisiestos + horas : anio + "/" +  mesesNoBisiestos + horas;
    ...
    public static boolean validarCuota(final String cuota) {
        if (cuota != null) {
            try {
                ...
                if (LOGGER.isErrorEnabled()) {
                    LOGGER.error("El formato de cuota introducido es erróneo. Vuelva a introducirlo");
                }
